 ...
 * formatter, not the claim. This file hit that twice before the helper existed.
 */
function prose(path) {
...
test("the clean-room tutorial needs no credential and no checkout", () => {
  ...
  assert.ok(!/KETQAT_API_TOKEN|kq_/.test(doc), "a clean-room tutorial that needs a token is not clean-room")
})
