 ...
 * records of hashes.
 */
export declare const STUDY_HASH_DOMAIN = "ketqat.study";
...
export declare const STUDY_SCHEMA_VERSION_KEY = "schema_version";
/**
 ...
 */
export declare const STUDY_KNOWN_HASH_RULES_IDS: readonly string[];
