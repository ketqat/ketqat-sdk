 ...
 * drifts.
 */
export const STUDY_EXCLUDED_KEYS = new Set([
    ...IDENTITY_KEYS,
...
const excludedByRulesId = {
    [STUDY_HASH_RULES_ID]: STUDY_EXCLUDED_KEYS,
};
function excludedFor(rulesId) {
    const excluded = excludedByRulesId[rulesId];
    if (!excluded) {
        throw new Error(`Unknown study hash rules id ${rulesId}. Known ids: ${Object.keys(excludedByRulesId).join(", ")}.`);
    }
    return excluded;
}
/**
