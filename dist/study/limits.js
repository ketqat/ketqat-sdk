 ...
 */
export const STUDY_HASH_REFUSAL_CODES = Object.freeze([
 ...
 */
const refusalCodes = new Set(STUDY_HASH_REFUSAL_CODES);
export function isStudyHashRefusalCode(value) {
...
export function refuse(code, message, path = null) {
    throw new StudyHashRefusalError(code, message, path);
}
export const STUDY_HASH_LIMITS = Object.freeze({
    max_depth: 64,
    max_nodes: 100000,
