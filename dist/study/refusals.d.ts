 ...
 */
export declare const StudyRefusalCodeSchema: z.ZodEnum<["STUDY_HASH_RULES_ID_MISSING", "STUDY_HASH_RULES_ID_UNKNOWN", "INVALID_STATUS_TRANSITION", "EVENT_CHAIN_BROKEN", "PLAN_NOT_CONFIRMED", "CONFIRMATION_HASH_MISMATCH", "PLAN_REVISION_SUPERSEDED", "PLAN_DEPENDS_ON_UNKNOWN", "CLAIM_WITHOUT_EVIDENCE_NODE", "CLAIM_VALUE_UNKNOWN", "EVIDENCE_NODE_UNRESOLVED", "EVIDENCE_EDGE_ENDPOINT_UNRESOLVED", "CREDITS_MAXIMUM_EXCEEDED", "BASELINE_SOURCE_UNKNOWN"]>;
