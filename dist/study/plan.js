...
import { BaselineSourceClassSchema, ContentHashSchema, RevisionRefSchema, STUDY_SCHEMA_VERSION, StudyPositionSchema, StudyQuantitySchema, } from "./common.js";
 ...
 */
export function revisePlan(current, changes, currentHash) {
    const withoutHash = {
        ...current,
        ...changes,
