 ...
 */
const ClaimValueRefShape = declareShape("study.claim_value_ref", [
    field("kind", "SEMANTIC"),
 ...
 */
const VersionPinShape = (name) => declareShape(name, [
 ...
 * not of a spelling.
 */
const ArtifactResolutionShape = declareShape("study.artifact_resolution", [
    field("kind", "SEMANTIC"),
    field("locator", "SEMANTIC"),
]);
const ArtifactRefShape = declareShape("study.artifact_ref", [
    field("name", "SEMANTIC"),
    field("role", "SEMANTIC"),
 ...
 * the answer says.
 */
const AnswerProvenanceShape = declareShape("study.answer_provenance", [
 ...
 * one.
 */
const OpenQuestionShape = declareShape("study.open_question", [
...
const CriterionThresholdShape = declareShape("study.criterion_threshold", [
 ...
 */
const StudyCriterionShape = declareShape("study.criterion", [
...
const SpecificationSuccessCriterionShape = declareShape("study.specification_success_criterion", [
    field("statement", "SEMANTIC", objectOf(TextFieldShape)),
    field("predicate", "SEMANTIC", objectOf(StudyCriterionShape)),
]);
const DataRetentionShape = declareShape("study.data_retention", [
    field("kind", "SEMANTIC"),
    field("days", "SEMANTIC"),
]);
const AllowedEgressShape = declareShape("study.allowed_egress", [
    field("kind", "SEMANTIC"),
    field("host", "SEMANTIC"),
]);
const DeletionPolicyShape = declareShape("study.deletion_policy", [
    field("kind", "SEMANTIC"),
 ...
 */
const DataHandlingPolicyShape = declareShape("study.data_handling_policy", [
 ...
 * read as new science.
 */
const GeneratedArtifactShape = declareShape("study.generated_artifact", [
    field("media_type", "SEMANTIC"),
    field("byte_size", "SEMANTIC"),
    field("content_hash", "SEMANTIC"),
]);
 ...
 */
const TableColumnShape = declareShape("study.table_column", [
 ...
 */
const TableCellShape = declareShape("study.table_cell", [
    field("column_id", "SEMANTIC"),
    field("text", "RECORD_ONLY"),
    field("node_hash", "SEMANTIC"),
]);
const TableRowShape = declareShape("study.table_row", [
 ...
 */
const StudyTableShape = declareShape("study.table", [
...
const FigureValueRefShape = (name) => declareShape(name, [
    field("kind", "SEMANTIC"),
    field("node_hash", "SEMANTIC"),
    field("table_id", "SEMANTIC"),
    field("row_id", "SEMANTIC"),
...
const FigurePointShape = declareShape("study.figure_point", [
...
const FigureSeriesShape = declareShape("study.figure_series", [
    field("series_id", "SEMANTIC"),
    field("label", "RECORD_ONLY"),
    field("points", "SEMANTIC", arrayOf(objectOf(FigurePointShape))),
]);
const FigureAxisShape = (name) => declareShape(name, [field("label", "RECORD_ONLY"), field("unit", "SEMANTIC")]);
const FigureSpecShape = declareShape("study.figure_spec", [
    field("kind", "SEMANTIC"),
 ...
 */
const StudyFigureShape = declareShape("study.figure", [
...
const ReportSegmentShape = declareShape("study.report_segment", [
...
const ReportSectionShape = declareShape("study.report_section", [
    field("section_id", "RECORD_ONLY"),
    field("title", "RECORD_ONLY"),
    field("segments", "RECORD_ONLY", arrayOf(objectOf(ReportSegmentShape))),
]);
const CommentaryBlockShape = declareShape("study.commentary_block", [
 ...
 */
const ReportDocumentShape = declareShape("study.report_document", [
...
const PlatformRequirementShape = declareShape("study.platform_requirement", [
    field("operating_system", "SEMANTIC"),
    field("architecture", "SEMANTIC"),
 ...
 */
const ReproductionRecipeShape = declareShape("study.reproduction_recipe", [
...
const EmbeddedBundleShape = declareShape("study.embedded_bundle", [
    field("media_type", "SEMANTIC"),
    field("byte_size", "SEMANTIC"),
    field("content_hash", "SEMANTIC"),
...
const CheckToolShape = declareShape("study.check_tool", [
 ...
 */
const CheckLedgerEntryShape = declareShape("study.check_ledger_entry", [
 ...
 * reason `study_id` is.
 */
const StudyCoreShape = declareShape("study.core", [
    field("study_type", "SEMANTIC"),
    field("project_ref", "SEMANTIC"),
    field("is_demo", "SEMANTIC"),
]);
const StudyPresentationShape = declareShape("study.presentation", [
    field("title", "RECORD_ONLY"),
...
const BackendSnapshotShape = declareShape("study.backend_snapshot", [
    field("provider", "SEMANTIC"),
    field("backend", "SEMANTIC"),
    field("snapshot_hash", "SEMANTIC"),
]);
const CostConfirmationShape = declareShape("study.cost_confirmation", [
    field("credits_charged", "SEMANTIC"),
    field("authorized_maximum", "SEMANTIC"),
    field("source", "SEMANTIC"),
]);
const QuotaConfirmationShape = declareShape("study.quota_confirmation", [
 ...
 */
const ExecutionEnvelopeShape = declareShape("study.execution_envelope", [
    field("kind", "SEMANTIC"),
 ...
 */
const ExecutionReceiptShape = declareShape("study.execution_receipt", [
...
const ResourceCeilingShape = declareShape("study.resource_ceiling", [
    field("max_credits", "SEMANTIC"),
    field("max_runtime", "SEMANTIC"),
    field("max_memory_bytes", "SEMANTIC"),
 ...
 */
const ConfirmationReceiptShapeDecl = declareShape("confirmation_receipt", [
    ...derivedHeaderFields("content_hash"),
    field("study_ref", "RECORD_ONLY"),
 ...
 */
const StudyTaskAuthorizationShapeDecl = declareShape("study_task_authorization", [
    ...derivedHeaderFields("content_hash"),
    field("study_ref", "RECORD_ONLY"),
    field("plan_ref", "SEMANTIC", objectOf(RevisionRefShape)),
    field("confirmation_receipt_ref", "SEMANTIC"),
 ...
 */
const TaskOutcomeShapeDecl = declareShape("task_outcome", [
    ...derivedHeaderFields("content_hash"),
    field("study_ref", "RECORD_ONLY"),
 ...
 */
const ReviewRecordShapeDecl = declareShape("review_record", [
    ...derivedHeaderFields("content_hash"),
    field("study_ref", "RECORD_ONLY"),
 ...
 */
const ReproductionRecordShapeDecl = declareShape("reproduction_record", [
    ...derivedHeaderFields("content_hash"),
    field("study_ref", "RECORD_ONLY"),
...
export const STUDY_CONTROL_PLANE_KINDS = Object.freeze([
    Object.freeze({
        record_kind: "execution_job",
        address_instead: "study_task_authorization",
        why: "a job is where the work is right now -- queued, leased, running, retried -- and a digest over state that " +
            "moves is a digest that stops matching itself between two reads of the same row",
    }),
]);
/** The working lookup, module-private and built from the frozen tuple. */
const controlPlaneByName = new Map(STUDY_CONTROL_PLANE_KINDS.map((entry) => [entry.record_kind, entry]));
/** The control-plane kind names, as immutable plain data. */
export const STUDY_CONTROL_PLANE_KIND_NAMES = Object.freeze(STUDY_CONTROL_PLANE_KINDS.map((entry) => entry.record_kind));
/**
...
export function studyRecordKind(recordKind) {
    ...
    if (entry === undefined) {
        ...
        if (controlPlane !== undefined) {
            refuse("NOT_CONTENT_ADDRESSED", `${JSON.stringify(recordKind)} is control-plane state and this family does not hash it: ` +
