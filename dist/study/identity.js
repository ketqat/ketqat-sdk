...
const OPAQUE_ID_MESSAGE = "An immutable ref is a lowercase RFC 4122 version 4 UUID: eight hex digits, three groups of four with the " +
...
export function isStudyOpaqueId(value) {
...
export const AuthenticatedSubjectSchema = z.string().regex(AUTHENTICATED_SUBJECT, {
    message: "An authenticated subject id is one printable ASCII token of 1 to 255 characters: no whitespace, no control " +
...
export function isAuthenticatedSubject(value) {
