import { z } from "zod";
import { CitationSchema, EnvironmentSchema, IsoDateTimeSchema, } from "../contracts/common.js";
...
import { EvidenceEdgeSchema, EvidenceNodeSchema, verifyEvidenceGraph, } from "./evidence.js";
...
function claimMapRefusals(body) {
    ...
    for (const node of body.nodes) {
        ...
        refusals.push({
            ...
            message: "This claim node appears in the package with no entry in the claim evidence map, so nothing states what it " +
